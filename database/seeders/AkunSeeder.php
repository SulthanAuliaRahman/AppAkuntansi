...
class AkunSeeder extends Seeder
{
    public function run(): void
    {
        $jenis = [
            ...
            '3.2' => JenisAkun::where('kode', '3.2')->first() ?? JenisAkun::create(['kode' => '3.2', 'nama' => 'Ikhtisar']),
        ];
        ...
        $data = [
            ...
            ['jenis_akun_id' => $jenis['3.2']?->id, 'kode_akun' => '313', 'nama_akun' => 'Ikhtisar Laba Rugi', 'saldo_normal' => 'KREDIT'],
