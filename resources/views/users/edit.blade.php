...
<div class="container mx-auto px-4 py-6 max-w-2xl">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <form action="{{ route('users.update', $user) }}" method="POST">
            ...
            <div class="mb-4">
                <label class="block text-gray-700 font-semibold mb-2">Password (kosongkan untuk tidak mengubah)</label>
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password_confirmation" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
                        ...
                        @foreach ($akuns as $akun)
                            <label class="flex items-center">
                                <input type="checkbox" name="akun_ids[]" value="{{ $akun['id'] }}"
                                    {{ in_array($akun['id'], $userAkunIds) ? 'checked' : '' }}
